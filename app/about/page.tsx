...
export default function AboutPage() {
  return (
    <>
      {/* Person Schema for Geoff Tucker */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "HubSpot implementation expert with over 15 years of experience specializing in private equity portfolio company optimizations.",
            knowsAbout: [
            ...
            alumniOf: "15+ years HubSpot experience",
            award: "30+ Successful Implementations",
          }),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Meet the team behind your data success. Specialized HubSpot implementation experts who rescue failed projects and transform chaotic systems into profit-driving platforms.",
            mainEntity: {
              "@type": "Organization",
              name: "DataOps Group",
            },
