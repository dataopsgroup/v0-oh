    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
                ...
                <div>
                  ...
                  <div className="space-y-6 body-copy text-gray-700 leading-relaxed">
                    <p>
                      ...
                      proper training, even the most powerful platform features remain untapped, leading to missed
                      opportunities and suboptimal results.
                    </p>
                    <p>
                      Our comprehensive HubSpot training programs are designed to accelerate platform adoption, increase
                      user confidence, and ensure your team leverages every feature to drive business growth. From basic
                      navigation to advanced automation strategies, we provide role-specific training that transforms
                      your team into HubSpot power users.
                    </p>
                    <p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="body-copy text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
                From basic platform navigation to advanced automation strategies, our training programs ensure your team
                maximizes HubSpot's potential and drives measurable business results.
              </p>
            </div>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="headline text-3xl md:text-4xl text-gray-900 mb-6">Our Training Implementation Approach</h2>
              <p className="body-copy text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="headline text-3xl md:text-4xl text-gray-900 mb-6">Common Training Challenges We Solve</h2>
              <p className="body-copy text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
