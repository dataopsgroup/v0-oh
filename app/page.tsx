      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            logo: "https://www.dataopsgroup.com/images/dataops-logo-horizontal.jpg",
            description:
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "DataOps Group",
            url: "https://www.dataopsgroup.com",
            description: "Turn PE Portfolio Operations Into Profit Drivers in 100 Days",
            publisher: {
              "@type": "Organization",
              name: "DataOps Group",
            },
            potentialAction: {
              "@type": "SearchAction",
              target: "https://www.dataopsgroup.com/search?q={search_term_string}",
