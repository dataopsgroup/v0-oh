          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex space-x-6">
                ...
                <Link href="#" className="text-sm body-copy text-blue-600 font-medium flex items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-6 my-8">
                  <div className="flex items-center space-x-3">
                    <div>
                      <h3 className="headline text-lg text-gray-900 font-semibold">19% Higher Valuations</h3>
                  ...
                  <div className="flex items-center space-x-3">
                    <div>
                      <h3 className="headline text-lg text-gray-900 font-semibold">100-Day Implementation</h3>
                  ...
                  <div className="flex items-center space-x-3">
                    <div>
                      <h3 className="headline text-lg text-gray-900 font-semibold">$18-22 ROI</h3>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  <h3 className="headline text-xl text-gray-900 mb-4">{feature.title}</h3>
                  <p className="body-copy text-gray-700 mb-6 flex-grow leading-relaxed">{feature.description}</p>
            ...
            <div className="mt-12 text-center">
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-8 text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button
                    variant="outline"
                    className="body-copy border-2 border-white text-white px-8 py-3 rounded-none hover:bg-white hover:text-blue-600"
                  >
                    <Link href="/contact">Talk To Us About Your Firm</Link>
                  </Button>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white text-gray-900 rounded-lg p-8">
                ...
                <div className="mt-8 space-y-4">
                  <Button className="body-copy w-full bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-none flex items-center justify-center">
                    <Link href="/#operations-assessment" className="flex items-center">
                  ...
                  <Button
                    variant="outline"
                    className="body-copy w-full border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-4 rounded-none flex items-center justify-center"
                  >
