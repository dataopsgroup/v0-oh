        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            <div className="text-center mb-12">
              <h1 className="headline text-4xl text-gray-900 mb-4">Privacy Policy</h1>
            </div>
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <div className="body-copy text-gray-700 leading-relaxed space-y-6">
                ...
                <h3 className="headline text-2xl text-gray-900 mt-12 mb-6">Interpretation and Definitions</h3>

                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Interpretation</h3>
                <p>
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Definitions</h3>
                ...
                <ul className="space-y-3 ml-6">
                  ...
                  <li>
                    ...
                    Agreement) refers to GeoffTucker.com LLC, 84 E Loveland Loop - B, Farmington, AR 72730.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Website</strong> refers to Geoff Tucker, accessible from https://www.geofftucker.com
                  </li>
                  <li>
                ...
                <h3 className="headline text-2xl text-gray-900 mt-12 mb-6">Collecting and Using Your Personal Data</h3>

                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Types of Data Collected</h3>

                <h3 className="headline text-lg text-gray-900 mt-6 mb-3">Personal Data</h3>
                <p>
                ...
                <h3 className="headline text-lg text-gray-900 mt-6 mb-3">Usage Data</h3>
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Tracking Technologies and Cookies</h3>
                <p>
                ...
                <ul className="space-y-3 ml-6">
                  <li>
                    <strong>Necessary / Essential Cookies</strong> Type: Session Cookies Administered by: Us Purpose:
                    These Cookies are essential to provide You with services available through the Website and to enable
                  ...
                  <li>
                    ...
                    Cookies allow us to remember choices You make when You use the Website, such as remembering your
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Use of Your Personal Data</h3>
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Retention of Your Personal Data</h3>
                <p>
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Transfer of Your Personal Data</h3>
                <p>
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Delete Your Personal Data</h3>
                <p>
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Disclosure of Your Personal Data</h3>

                <h3 className="headline text-lg text-gray-900 mt-6 mb-3">Business Transactions</h3>
                <p>
                ...
                <h3 className="headline text-lg text-gray-900 mt-6 mb-3">Law enforcement</h3>
                <p>
                ...
                <h3 className="headline text-lg text-gray-900 mt-6 mb-3">Other legal requirements</h3>
                <p>
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Security of Your Personal Data</h3>
                <p>
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Children's Privacy</h3>
                <p>
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Links to Other Websites</h3>
                <p>
                ...
                <h3 className="headline text-xl text-gray-900 mt-8 mb-4">Changes to this Privacy Policy</h3>
                <p>
