...
export default function BlogPostHeader({ title, author, date, category, content }: BlogPostHeaderProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-dataops-light-blue/20 to-white border-b border-gray-200">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 className="text-5xl font-bold text-gray-900 mb-4 leading-tight">{title}</h1>
