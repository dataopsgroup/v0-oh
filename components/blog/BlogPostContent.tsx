    ...
    <div className="blog-content">
      ...
      <div
        ...
        className="blog-content-inner prose prose-lg max-w-none
          ...
          [&_h2]:text-3xl [&_h2]:font-bold [&_h2]:text-gray-900 [&_h2]:mb-6 [&_h2]:mt-10 [&_h2]:border-b [&_h2]:border-gray-200 [&_h2]:pb-2
          ...
          [&_blockquote]:border-l-4 [&_blockquote]:border-blue-500 [&_blockquote]:bg-blue-50 [&_blockquote]:p-4 [&_blockquote]:my-6 [&_blockquote]:italic
